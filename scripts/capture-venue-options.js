...
async function run() {
  const browser = spawn('helium-browser', [
    ...
    '--disable-gpu',
    '--incognito',
    '--user-data-dir=/tmp/helium-venue-' + Date.now(),
    '--remote-debugging-port=9224',
    '--window-size=420,1200',
    'http://127.0.0.1:8899/docs/mockup/venue-placement-options.html'
  ]);
  ...
  try {
    ...
    fs.writeFileSync(`${ARTIFACT_DIR}/venue_placement_options.png`, Buffer.from(shot.data, 'base64'));
    console.log('Saved venue_placement_options.png');
