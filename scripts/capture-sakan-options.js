...
async function run() {
  const browser = spawn('helium-browser', [
    ...
    '--disable-gpu',
    '--incognito',
    '--user-data-dir=/tmp/helium-sakan-' + Date.now(),
    '--remote-debugging-port=9227',
    '--window-size=440,1300',
    'http://127.0.0.1:8899/docs/mockup/sakan-display-options.html'
  ]);
  ...
  try {
    ...
    fs.writeFileSync(`${ARTIFACT_DIR}/sakan_display_options.png`, Buffer.from(shot.data, 'base64'));
    console.log('Saved sakan_display_options.png');
