...
async function run() {
  const browser = spawn('helium-browser', [
    ...
    '--disable-gpu',
    '--incognito',
    '--user-data-dir=/tmp/helium-v3-' + Date.now(),
    '--remote-debugging-port=9225',
    '--window-size=420,1300',
    'http://127.0.0.1:8899/docs/mockup/variant3-refined.html'
  ]);
  ...
  try {
    ...
    fs.writeFileSync(`${ARTIFACT_DIR}/variant3_refined_preview.png`, Buffer.from(shot.data, 'base64'));
    console.log('Saved variant3_refined_preview.png');
